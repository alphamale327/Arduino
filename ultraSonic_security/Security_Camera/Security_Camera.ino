...
// On Mega: camera TX connected to pin 69 (A15), camera RX to pin 8:
//SoftwareSerial cameraconnection = SoftwareSerial(69, 8)
#else
...
void loop() {
  /*
  if (blueToothConnect.available()){
    bluetoothData=blueToothConnect.read();
    if(BluetoothData=='1'){   // if number 1 pressed ....
      digitalWrite(led1,1);
      blueToothConnect.println("LED ON ! ");
     }
    if (BluetoothData=='0'){// if number 0 pressed ....
      digitalWrite(led1,0);
      blueToothConnect.println("LED Off ! ");
    }
  }
  */
...
//  Serial.println(" cm");
  if(distance > 0 && distance < 10){
    ...
    Serial.print("A motion is dectected in ");
    Serial.print(distance);
    Serial.println(" cm");
    
    blueToothConnect.print("A motion is dectected in ");
    blueToothConnect.print(distance);
    blueToothConnect.println(" cm");
    takePic();
  }
...
void takePic(){  
  Serial.println("Try taking a picture");
  blueToothConnect.println("Try taking a picture");  
...
cam.setMotionDetect(true);      
  ...
  blueToothConnect.print("A picture is stored in ");
